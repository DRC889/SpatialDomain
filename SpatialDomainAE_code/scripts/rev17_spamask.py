...
SPM = "/scratch/users/nus/e1503317/rev_src/spamask-x/SpaMask-main"
sys.path.insert(0, SPM)
from SpaMask.spaMask import SPAMASK

RAW = Path("/data/projects/11003054/dmeng/works/prbio/stokeomics/SpatialStroke/data/processed/adata_combined.h5ad")
