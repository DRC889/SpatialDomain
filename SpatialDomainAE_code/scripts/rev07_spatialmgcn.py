...
Run:
  PYTHONPATH=/scratch/users/nus/e1503317/rev_pkgs <lin_MultiVI py> \
  rev07_spatialmgcn.py --dataset stroke --seeds 0,1,2 --device cuda:0 \
...
SMGCN = "/scratch/users/nus/e1503317/rev_src/smgcn-extract/Spatial-MGCN-master/Spatial-MGCN"
